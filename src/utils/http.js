...
export function post (url, data, options) {
	...
	const ifNotQsStringfy = _options.headers && _options.headers['Content-Type'] && _options.headers['Content-Type'] !== 'application/x-www-form-urlencoded'
	return new Promise((resolve, reject) => {
		axios.post(url, ifNotQsStringfy ? data : qs.stringify(data), {//需要qs格式化body 当传输格式为urlencoded时
