...
import './mdcConfigStyle/fileModifyModal.less'
...
const fileModifyModal = Form.create()(
	class extends React.Component {
		...
		render() {
			...
			return (
				<div className="fileModifyModal">
					<Modal
						title="配置"
						width="900px"
						wrapClassName={'fileModifyModalContent'}
						maskClosable={false}
						cancelText={'取消'}
						okText={'确定'}
					...
					>
						<Form>
							<FormItem {...formItemLayout} label="请选择MDC：">
								{
									<Select
							...
							<FormItem {...formItemLayout} label="上游cfs服务：">
								<Input
									ref="myInput"
